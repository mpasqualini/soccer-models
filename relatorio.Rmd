...
![Pontuação acumulada - Modelo 1](/home/mariana/Documents/pessoal/monografia/soccer-models/artifacts/model1-cumsum-brasileirao2019.png)
...
```{r}
pontuacao_m1 <- read_rds("/home/mariana/Documents/pessoal/monografia/soccer-models/artifacts/pontuacao_total_m1.rds")

kable(pontuacao_m1, booktabs = T) |> 
  kable_styling(position = "center", latex_options = "hold_position")
```
...
![Pontuação acumulada - Modelo 2](/home/mariana/Documents/pessoal/monografia/soccer-models/artifacts/model2-cumsum-brasileirao2019.png)
