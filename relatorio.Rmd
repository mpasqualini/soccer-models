...
![Convergência - Modelo 1](artifacts/traceplot_m1.png)
...
As simulações foram realizadas com apenas 01 cadeia e 5000 interações. O gráfico traceplot mostra que a cadeia converge e consegue iterar por todo espaço paramétrico.
...
```{r}
read_rds("artifacts/2019/pontuacao_total_m2.rds") |> 
  rename("Time" = team_name,
         "Pontuação observada" = score_obs, 
         "Pontuação estimada (Modelo 2)" = score_est_m2) |>
  kable(booktabs = T) |> 
  kable_styling(position = "center", 
                latex_options = "hold_position")
```
